...
import net.masterquentus.hexcraftmod.block.entity.custom.WhiteChalkMarkBlock;
...
public class WhiteChalkItem extends Item {
    ...
    private final Block whiteChalkMarkBlock;

    public WhiteChalkItem(Block markBlock, Properties properties) {
        super(properties);
        this.whiteChalkMarkBlock = markBlock;
    }
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (!level.isClientSide && context.getPlayer() != null) {
            int glyph = level.random.nextInt(6) + 1; // White chalk has 6 glyphs

            BlockState state = whiteChalkMarkBlock.defaultBlockState()
                    .setValue(WhiteChalkMarkBlock.GLYPH, glyph);
